...
import {
  ARTICLE_LOCALES,
  ARTICLE_REQUIRED_TRANSLATION_FIELDS,
...
/**
 * The Articles EDITOR's form model, payload builder and Zod schema.
 *
 * Deliberately separate from `admin-article-fields.ts`: importing one of the field helpers used to
 * drag this whole module — and Zod schema code — onto the collection route, measured at 8,889 B for
 * a page that gained no features. Only the editor imports this file.
 *
 * Nuxt-free, so it unit-tests without a runtime.
 */
