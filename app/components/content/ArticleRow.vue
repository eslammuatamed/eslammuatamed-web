...
<template>
  <!-- Same shared `row-glass` affordance as the project index row (025) — one class, so the two
       repeated public row types cannot drift apart. -->
  <article
    class="group row-glass relative grid gap-x-10 gap-y-3 border-t border-default py-7 transition first:border-t-0 md:grid-cols-[1fr_auto] md:items-baseline"
  >
    <div>
