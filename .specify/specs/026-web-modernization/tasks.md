...
**No owner decision is open.** OD-26-6 was **resolved 2026-08-16** (`'client'`, above), OD-26-5 **resolved 2026-08-16** (option A, above), OD-26-4 **resolved 2026-08-16** (option D, above); OD-26-1 and OD-26-3 are closed. OD-26-2 remains *contingent*, raised only if T2.2 measures the 191 B as
