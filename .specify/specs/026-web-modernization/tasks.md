...
⚠ **Next action: the owner answers OD-26-8, now escalated as a D20-24 BUDGET-MODEL question.**
The governed decision package is ledger **§24.20** (measured at Web `8067ec8`). ⚠ **§24.17's
Option A/B probe recommendation is WITHDRAWN** — the owner rejected both remedies, so those builds
would measure what cannot be adopted. **Do not start T5.B/D/F/G/H.** Full zero-trust resume state:
ledger **§24.17 as superseded by §24.20**.
